...
#Training Session 2
#rlAgent.initTraining(0.2, 0.2, 0.3)
#ttt.train(rlAgent, partner, 9900)
"""
...
class RLPlayer(Player):
	...
	def rewardState(self, board, prevBoard=None):
		...
		if prevBoard is None:
			...
			reward = self.getReward(board)
			currentKey = board.getKey(self.letter)
			currentValue = self.valueOfState(currentKey)
